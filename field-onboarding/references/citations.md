...
Loaded whenever you are about to name a specific work: Rung 5, any reading
path, and every attributed claim in an unsettled field. Query templates for
the verification itself are in `search-recipes.md`.
