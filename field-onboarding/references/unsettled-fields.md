# Fields that are not settled

Loaded when the calibration check in `SKILL.md` finds the field is emerging,
contested, or beyond what you can reliably describe.
