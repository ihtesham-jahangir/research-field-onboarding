...
🆕 **v1.7.0 新增** — 现在可以选它怎么讲了。先物理图像、平衡、还是先推导，三种
深度一样，只是顺序不同，而且中途随时能换。[跳到三种风格](#选它怎么讲)。
...
<p align="center">
  <img src="demo.gif" width="900" alt="问起二次谐波产生：skill 先列出四个前置概念，让你标注用过 / 学过 / 没接触，然后讲第一级，最后出一道检验题。"/>
</p>
...
用下来觉得哪里不对，欢迎
[开一个 issue](https://github.com/ljx-chase/research-field-onboarding/issues)。
更新记录里的大部分改动，来自我自己拿它读东西时撞上的问题。这个样本很窄：一个人，
基本只有物理和机器学习。如果它在我根本不会去的地方坏掉，那正是我最想知道的，也比
一个 star 对我有用得多。前置概念在你的领域里列错了、检查点的题从那一级根本答不出来、给的文献
查无此文，这些都值得说一声。eval 用例集就是为了让修一个问题不会悄悄弄坏另一个。

觉得有用的话，点个 star 能让更多人看到。想知道规则什么时候变了，Watch 这个仓库会
收到通知，star 不会。
