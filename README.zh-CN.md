...
<p align="center">
  <img src="docs/demo.gif" width="900" alt="问起二次谐波产生：skill 先列出四个前置概念，让你标注用过 / 学过 / 没接触，然后讲第一级，最后出一道检验题。"/>
</p>
...
上面更新记录里的每一条改动，都来自真的有人用了它然后告诉我哪里坏掉，这比一个 star
对我有用得多。前置概念在你的领域里列错了、检查点的题从那一级根本答不出来、给的文献
